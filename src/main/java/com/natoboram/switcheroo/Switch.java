...
public class Switch {
	...
	public static void switcheroo(final PlayerEntity player, final ItemStack item, final SwitcherooConfig config) {
		...
		if (PlayerInventory.isValidHotbarIndex(slot)) {
			...
			CLIENT.interactionManager.clickSlot(player.playerScreenHandler.syncId, slot, nextSlot, SlotActionType.SWAP,
					player);
		}
	}
	 ...
	 */
	static private int findEmptyOrCurrentHotbarSlot(final PlayerInventory inventory) {
